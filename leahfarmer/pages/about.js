        ...
        <section className={styles.aboutBody}>
          <div className={styles.aboutBodyInner}>
            ...
            <div className={styles.elsewhere}>
              <p>If you want to read more of my writing, you can find me on <a href="https://leahfarmer.substack.com" target="_blank" rel="noopener">Substack</a>. I also co-host <a href="https://practicalproductmanagementpodcast.com" target="_blank" rel="noopener">Practical Product Management</a> with Marilyn McDonald — a podcast about the real craft of product, not the theory.</p>
            </div>
