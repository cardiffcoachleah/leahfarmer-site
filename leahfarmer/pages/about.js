        ...
        <section className={styles.aboutBody}>
          <div className={styles.aboutBodyInner}>
            ...
            <div className={styles.elsewhere}>
              ...
              <p>And I run <a href="https://thelaunchbyleah.com" target="_blank" rel="noopener">The Launch by Leah</a> — a small studio where I build websites for coaches, healers, and solopreneurs ready to go public with their work.</p>
            </div>
